<template>
  <div ref="chartContainer" class="bar-chart-container" :style="{ height: containerHeight }">
    ...
    <div ref="chartElement" class="bar-chart" :style="{ height: height }"></div>
  </div>
</template>
...
const getChartOptions = () => {
  ...
  return {
    ...
    xAxis: props.showAxis ? {
      ...
      data: isHorizontal ? null : props.xAxisData,
      axisLine: {
        lineStyle: {
    ...
    yAxis: props.showAxis ? {
      ...
      data: isHorizontal ? props.xAxisData : null,
      axisLine: {
        lineStyle: {
          color: props.theme === 'dark' ? 'rgba(255, 255, 255, 0.3)' : '#ccc'
        }
